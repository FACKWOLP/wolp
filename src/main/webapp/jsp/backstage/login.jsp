...
<div class="logintop">    
    ...
    <ul>
    <li><input name="a" type="text" class="loginuser" value="admin" onclick="JavaScript:this.value=''"/></li>
    <li><input name="b" type="text" class="loginpwd" value="密码" onclick="JavaScript:this.value=''"/></li>
